...
- When using mobile_action, you must wait for the user's response after each action to confirm success and receive the updated device state. For example, when testing a mobile app, you would launch the device, wait for confirmation and the initial screenshot, then perform actions like tapping or swiping based on the screenshot coordinates, waiting for confirmation and a new screenshot after each action, before finally closing the device.${
		supportsComputerUse
